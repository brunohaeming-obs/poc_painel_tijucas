...
def main() -> None:
    ...
    indicadores = {
        "emprego": pd.read_csv(SOCIAL_DATA_DIR / "mte_saldo_tijucas_sc_mensal.csv").to_dict("records"),
        "saude": pd.read_csv(HEALTH_DATA_DIR / "datasus_procedimentos_tijucas_sc_mensal.csv").to_dict("records"),
        "bolsaFamilia": pd.read_csv(SOCIAL_DATA_DIR / "bolsa_familia_sc_total_mensal.csv").tail(36).to_dict("records"),
    }
